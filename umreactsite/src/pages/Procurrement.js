...
class Procurement extends React.Component{
    ...
    render(){
                    ...
                    <ul id="top-menu" className="nav navbar-nav navbar-right mu-main-nav">
                      ...
                      <li className="dropdown">
                        <a className="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Opportunities <span className="caret" />
                          ...
                          <Link className="active" to='/Tender'>Procurement</Link></li>
        ...
        ================================================== */}
            ...
            <hr />
            <div className="container">
              <h1 style={{color: 'black'}}><b>Open Tenders</b></h1>
              <div className="box">
                <div className="box-col box-80">
                  <h4>There are no open tenders at present</h4>
                  {/* <a target="_blank" href="MFA_FORM_2015A.pdf">Download Documents</a>        
                   </div>
                   
                   <div class="box-col box-20 text-right">
                    <a class="button" href="RQF.html">Request for Quotations</a>
                   </div>
    
                   <hr>
                   <span class="function">Submit Tender Documentation To The Following E-mail Address: tenders@umsmining.co.za</span>            */}
                </div>
              </div>
            </div>
