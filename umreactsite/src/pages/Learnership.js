...
class Learnership extends React.Component{
                    ...
                    <ul id="top-menu" className="nav navbar-nav navbar-right mu-main-nav">
                      ...
                      <li className="dropdown">
                        <a className="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Opportunities <span className="caret" />
                          ...
                          <li><Link   className="active" to='/Learnership'>Leanership</Link></li> 
    ...
    ================================================== */}
        ...
        <hr />
        <div className="container">
          <h1 style={{color: 'black'}}><b>Open Learnership</b></h1>
          <div className="box">
            <div className="box-col box-80">
              <h4>There are no vacancies at present</h4>
              {/* <span class="function">2021</span> */}
            </div>
            {/* <div class="box-col box-20 text-right">
                <a class="button" href="Form.html">Apply</a>
               </div> */}
          </div>
          {/* <div class="box">
               <div class="box-col box-80">
                  <h4>Machine Operators</h4>
                 <span class="function">2021</span>
               </div>
